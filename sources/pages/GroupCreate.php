 ...
 * Create group page here
 */

require_once("./controllers/groupCreate_controller.php");
...
<head>
    ...
    <title>Invitations de groupes - Flight Club</title>
            ...
            <section class="clean-block clean-form dark">
                <div class="container">
                    <div class="block-heading">
                        <h2 class="text-info">Créer un groupe</h2>
                        <p>Créer un groupe et invitez vos amis a vous rejoindre</p>
                    </div>
