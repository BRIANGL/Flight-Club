 ...
 * Group member list page here
 */

require_once("./controllers/groupMember_controller.php");
...
<head>
    ...
    <title>Liste des utilisateures de ce groupe - Flight Club</title>
            ...
            <section class="clean-block clean-form dark">
                <div class="container">
                    <div class="block-heading">
                        ...
                        <p>Toutes les utilisateures du groupe "<?= groupName($groupDATA) ?>" </p>
                    </div>
                    <form>
